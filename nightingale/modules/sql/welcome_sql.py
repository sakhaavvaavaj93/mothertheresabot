...
from nightingale.modules.helper_funcs.msg_types import Types
from nightingale.modules.sql import SESSION, BASE

DEFAULT_WELCOME = "hallo' {first}, 'എവിടെയാ തള്ളി കയറി പോകുന്നെ ?  പേര്, നാട് , ജോലി  ഇവ പറഞ്ഞിട്ട് പോയാൽ മതി . അവിടെ നിൽക് "
DEFAULT_GOODBYE = 'ഇപ്പൊ പൊയ്ക്കോ .... എന്നെങ്കിലും നിന്നെ എൻ്റെ കയ്യിൽ കിട്ടും ... അന്ന് തന്നോളാം ബാക്കി ...'

DEFAULT_WELCOME_MESSAGES = [
    "{first}, സൗഹൃദത്തിൻ്റെ പുതിയ പടവുകളിലേക് താങ്കൾക്ക് ഹാർദ്ദവമായ സ്വാഗതം ...",
]
DEFAULT_GOODBYE_MESSAGES = [
    "{first}, നീ പോയിട്ട് എപ്പോഴെങ്കിലും ഇതുവഴി വരുമല്ലോ ... അന്ന് കണ്ടോളാം ... ",
    "{first}, സംഭവാമി യുഗേ യുഗേ",
]
