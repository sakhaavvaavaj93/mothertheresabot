...
from nightingale import dispatcher, LOGGER
...
from nightingale.modules.helper_funcs.extraction import extract_text
from nightingale.modules.helper_funcs.filters import CustomFilters
from nightingale.modules.helper_funcs.misc import build_keyboard
from nightingale.modules.helper_funcs.string_handling import split_quotes, button_markdown_parser
from nightingale.modules.sql import cust_filters_sql as sql
                ...
                try:
                    ...
                    if excp.message == "Unsupported url protocol":
                        message.reply_text("You seem to be trying to use an unsupported url protocol. Telegram "
                                           ...
                                           "again, or ask in @AnonymousD3061 for help.")
                        ...
                        message.reply_text("This note could not be sent, as it is incorrectly formatted. Ask in "
                                           "@AnonymousD3061 if you can't figure out why!")
