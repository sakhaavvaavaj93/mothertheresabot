...
from nightingale import dispatcher, OWNER_ID, SUDO_USERS, WHITELIST_USERS, MESSAGE_DUMP, LOGGER
from nightingale.modules.helper_funcs.handlers import CMD_STARTERS
from nightingale.modules.helper_funcs.misc import is_module_loaded, send_to_list
...
import nightingale.modules.sql.feds_sql as sql
from nightingale.modules.helper_funcs.alternate import send_message
    ...
    if args:
        if args[0] == 'json':
            ...
            with BytesIO(str.encode(backups)) as output:
                output.name = "nightingale_fbanned_users.json"
            ...
            with BytesIO(str.encode(backups)) as output:
                ...
                update.effective_message.reply_document(document=output, filename="nightingale_fbanned_users.csv",
