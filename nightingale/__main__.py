...
from nightingale import dispatcher, updater, TOKEN, WEBHOOK, SUDO_USERS, OWNER_ID, CERT_PATH, PORT, URL, LOGGER, \
    ALLOW_EXCL, TOKEN
from nightingale.modules import ALL_MODULES
from nightingale.modules.helper_funcs.chat_status import is_user_admin
from nightingale.modules.helper_funcs.misc import paginate_modules
import nightingale.modules.helper_funcs.panel_string as HELP_PANEL_STRING
from nightingale.modules.connection import connected
from nightingale.modules.connection import connect_button
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("nightingale.modules." + module_name)
...
def start(bot: Bot, update: Update, args: List[str]):
    ...
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_text("i am nightingale. a powerful tg bot with lots of plugins to use the secure tg_world .made by @vaasukionfire7966")
...
def send_start(bot, update):
    ...
    text = "ᏂᏗᎥ ᏰᏒᎧ ,Ꭵ ᏗᎷ ☿︎☂︎ᏁᎥᎶᏂᏖᎥᏁᏗᏝᏋ ♫♫"
    ...
    keyboard += [[InlineKeyboardButton(text="💠Add Me💠",url="http://t.me/vaasukionfire7966?startgroup=true"),InlineKeyboardButton(text="♻️Owner",url="https://telegram.dog/vaasukionfire7966")]]
    ...
    if chat.type != chat.PRIVATE:
        ...
        update.effective_message.reply_text("Contact me in PM to get the list of possible commands.",
                                            reply_markup=InlineKeyboardMarkup(
                                                ...
                                                InlineKeyboardButton(text="💫Channel",url="https://telegram.dog/LIFE_OF_RYTHEMofficial")]]))
        return
